...
func TestAliasesAreAliases(t *testing.T) {
	var fromRoot tunneld.BuilderV1[string] = tunneld.New[string]()
	var fromV1 v1.Builder[string] = fromRoot
	fromRoot = fromV1

	var resultRoot tunneld.Result[string] = fromRoot.WithValue("hello").Build()
...
func TestFacadeCoversTheCommonPath(t *testing.T) {
	var b tunneld.BuilderV1[int] = tunneld.New[int]()
