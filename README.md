...
in its border which key is waiting. It does not claim the key is about to end
anything — most of the time it is not; `Ctrl-C` at a shell prompt clears the
line — only that this terminal cannot be reopened.
